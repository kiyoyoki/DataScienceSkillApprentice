...
1. (2022/03/19)名義尺度の変数をダミー変数に変換する方法を知る
1. (2022/03/22)データ可視化における目的として「探索目的」「検証目的」「伝達目的」の大きく分けて3つの目的があることを理解する
1. (2022/03/22)数値データの特徴量化(二値化/離散化，対数変換)について理解する
1. (2022/03/25)数値データの特徴量化(スケーリング/正規化)について理解する
1. (2022/03/26)数値データの特徴量化(交互作用特徴量の生成)について理解する
1. (2022/03/29)散布図などの軸だしにおいて，縦軸・横軸の候補を適切に洗い出す考え方を知る
1. (2022/03/29)積み上げ縦棒グラフでの属性の選択など，適切な層化(比較軸)の候補の出し方を知る